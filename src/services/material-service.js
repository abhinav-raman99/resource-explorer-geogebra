...
export function fetchMaterials(params) {
  return _fetcher('/materials', params)
    .then((materials) => materials.map(_prepareMaterial));
}

/**
 * Performs a GET request to fetch a single material object.
 *
 * See: https://groot.geogebra.org:555/?url=https://groot.geogebra.org:5400/v1.0/openapi#/materials/Materials%5CController%5CMaterialController%3A%3Aget
 * @param id id of the material
 * @param params equivalent with the parameters of GET /materials/{id} call
 * @returns {Promise<*>}
 */
export function fetchMaterial(id, params) {
  return _fetcher(`/material/${id}`, params)
    .then(_prepareMaterial);
}